			...
			<div class="col-12 col-md-6">
				<div class="mb-md-0 mb-30 p-30 bg-primary-light rounded">
					<div class="d-flex justify-content-between align-items-center">
						...
						<div>
							<img src="../../images/front-end-img/about/banner-img-1.png" class="img-fluid" alt="">
						</div>
					</div>
				</div>
			</div>
			<div class="col-12 col-md-6">
				<div class="p-30 bg-info-light rounded">
					<div class="d-flex justify-content-between align-items-center">
						...
						<div>
							<img src="../../images/front-end-img/about/banner-img-2.png" class="img-fluid" alt="">
						</div>
					</div>
				</div>
			</div>
	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-lg-7 col-12 text-center">
				<h1 class="mb-15">Top 10 sinh viên có thành tích tốt</h1>
										...
										<div class="box">
											...
											<div class="box-body">
												<div class="text-start">
													<h4 class="box-title"><a href="" class="tenchuyende">
															<?php echo $dscd['name'] ?>
														</a></h4>
	...
	<div class="container">
		<div class="row align-items-center justify-content-between mb-5">
			<div class="col-md-5 col-sm-12" data-aos="fade-up">
				<div class="cpt-tx">
					<h2 class="mb-3">Chúng tôi có nền giáo dục tốt nhất trên thành phố</h2>
					...
					<div class="mb-3 me-4 ms-lg-0 me-lg-4">
						<div class="d-flex align-items-center">
							...
							<h6 class="mb-0 ms-3">Truy cập trọn đời</h6>
						</div>
					</div>
					<div class="mb-3 me-4 ms-lg-0 me-lg-4">
						<div class="d-flex align-items-center">
							...
							<h6 class="mb-0 ms-3">Hơn 20 tài nguyên có thể tải xuống</h6>
						</div>
					</div>
					<div class="mb-3 me-4 ms-lg-0 me-lg-4">
						<div class="d-flex align-items-center">
							...
							<h6 class="mb-0 ms-3">Chứng chỉ hoàn tất</h6>
						</div>
					</div>
					<div class="mb-3 me-4 ms-lg-0 me-lg-4">
						<div class="d-flex align-items-center">
							...
							<h6 class="mb-0 ms-3">Dùng thử miễn phí 7 ngày </h6>
						</div>
					</div>
					<div class="text-start mt-4"><a href="?act=login" class="btn btn-primary">Đăng kí ngay</a></div>
				</div>
			</div>
					...
					<div class="item">
						<div class="testimonial-bx">
							...
							<div class="testimonial-content">
								<p class="fs-16">Contrary to popular belief, Lorem Ipsum is not simply random text. It
